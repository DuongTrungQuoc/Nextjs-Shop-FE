...
import { styled, MenuItem, Pagination, PaginationProps, Select } from '@mui/material'
...
const CustomPagination = React.forwardRef((props: TProps, ref: Ref<any>) => {
  ...
  return (
    <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%', padding: '8px' }}>
      <Box>
